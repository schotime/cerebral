...
export default class Router {
  ...
  onUrlChange(event) {
    ...
    if (
      ...
      if (typeof signal === 'string') {
        ...
        this.controller.runSignal(this.activeRoute.route || '/', signal, payload);
      }
    }
  ...
  onSignalStart(execution, payload) {
    const route = this.routesBySignal[execution.name] || this.routesBySignal[execution.staticTree.items[0].function.toString()]
    if (!route) return
